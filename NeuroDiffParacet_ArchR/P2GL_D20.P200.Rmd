---
#==========================================================================================================================
title: "Neuronal Differentiation Paracet scATACSeq p2Glinksd20.p200 "
author: "Ankush Sharma"
date: "`r Sys.Date()`"
output: html_document
Description: This script analyzes the peak2genelinks analysis for D20 P200 sample for kmeans of 5 of the manuscript  as seen in manuscript figure of Spildrejorde et al. 
...
idxSample <- BiocGenerics::which(paracetP5$Sample %in% "D20.P200")
...
write.table(mergedp2g_d20,"day20p200_paracet_peak2genelinks_corr_0.45_res-1_loopobject.txt")

p_d20.p200 <- plotPeak2GeneHeatmap(ArchRProj = day20_archr, groupBy = "Clusters2",
seed = 1,
...
##plotPDF(p_d20.p200, name = "__d20p200_Paracet_5_Plot-Heatmap_peak2genelinks-scRNA_scATAC_blueyellow_purpleOrange_updated.pdf",pal = constrained_palette, ArchRProj = day20_archr, addDOC = TRUE, width = 6, height = 16)
p_d20.p200
dev.copy(pdf,paste0("__d20p200_Paracet_5_Plot-Heatmap_peak2genelinks-scRNA_scATAC_blueyellow_purpleOrange_updated.pdf"), width=6, height=16, paper='special')
dev.off()    
...
dev.copy(pdf,paste0(currentjob,"day20p200_top25000rgreatanalysis_d20p100_kmeans1"), height=5, width=8)
dev.off()
#tb = getEnrichmentTables((job), download_by = 'tsv')
write.table(tb$`GO Biological Process`,"_d20p200_top25000_kmeans1_bioloigical_process.tsv")
...
tb = getEnrichmentTables(job)
res = plotRegionGeneAssociationGraphs(job)
dev.copy(pdf,paste0(currentjob,"_day20p200_rgreatanalysisd20kmeans2"), height=5, width=8)
dev.off()
#tb = getEnrichmentTables((job), download_by = 'tsv')
write.table(tb$`GO Biological Process`,"_day20p200_kmeans2_bioloigical_process.tsv")
...
tb = getEnrichmentTables(job)
res = plotRegionGeneAssociationGraphs(job)
dev.copy(pdf,paste0(currentjob,"_day20p200_rgreatanalysisd20kmeans3"), height=5, width=8)
dev.off()
#tb = getEnrichmentTables((job), download_by = 'tsv')
write.table(tb$`GO Biological Process`,"_day20p200_kmeans3_bioloigical_process.tsv")
...
tb = getEnrichmentTables(job)
res = plotRegionGeneAssociationGraphs(job)
dev.copy(pdf,paste0(currentjob,"_day20p200_rgreatanalysisd20kmeans4"), height=5, width=8)
dev.off()
#tb = getEnrichmentTables((job), download_by = 'tsv')
write.table(tb$`GO Biological Process`,"_day20p200_kmeans4_bioloigical_process.tsv")
...
tb = getEnrichmentTables(job)
res = plotRegionGeneAssociationGraphs(job)
dev.copy(pdf,paste0(currentjob,"_day20p200_rgreatanalysisd20kmeans5"), height=5, width=8)
dev.off()
#tb = getEnrichmentTables((job), download_by = 'tsv')
write.table(tb$`GO Biological Process`,"_day20p200_kmeans5_bioloigical_process.tsv")
...
dev.copy(pdf,paste0("_gprofiler_D20_p200Kmeans_corr_0.7_significant_",currentjob,".pdf"), width=16, height=12,paper='special')
dev.off()
gostplot(multi_gostres1, capped = TRUE, interactive = TRUE)
fwrite(multi_gostres1$result, file ="_d20p200_gprofiler_kmeans_gostplot_corrgreaterthan0.7_significant.csv")
...
publish_gosttable(multi_gostres1, 
                  ...
                  filename = NULL)+
  ggtitle('Biological Processes')
dev.copy(pdf,paste0("_gprofiler_D0_p200_Kmeans_corr_0.45_significant_",currentjob,".pdf"), width=16, height=12,paper='special')
dev.off()
gostplot(multi_gostres1, capped = TRUE, interactive = FALSE)
dev.copy(pdf,paste0("_gprofiler_gostplot_D20.p200_Kmeans_corr_0.45_significant_",currentjob,".pdf"), width=16, height=8,paper='special')
fwrite(multi_gostres1$result, file ="_gprofiler_d20.p200kmeans_gostplot_corrgreaterthan0.45_significant.csv")
...
library(ggplot2)
p_GSM_d20
dev.copy(pdf,paste0("_D20_p200_positiveTFRegulators_genescorematrixpvalue_smaller label",currentjob,".pdf"), width=8, height=10,paper='special')
dev.off()
...
p1_GIM_d20
dev.copy(pdf,paste0("_D20.p200_positiveTFRegulators_geneintegrationmatrix_smaller_label",currentjob,".pdf"), width=8, height=10,paper='special')
dev.off()

write.table(corGIM_MM_d20,"D20.p200_geneintegrationmatrix_positivetfRegulator_all.tsv")
