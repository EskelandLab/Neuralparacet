...
### Page title 
titlePanel(" Effects of Paracetamol Neuronal Differentiation - scRNA Dataset"),  
navbarPage( 
  NULL,  
...
p(em("For more details Visit "), a("CanCell", 
  href = "https://cancell.medisin.uio.no/",target="_blank")), 
br(),br(),br(),br(),br() 
))) 
